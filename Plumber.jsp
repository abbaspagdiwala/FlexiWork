...
<body>
	<nav class="navbar">
		<div class="logo">FlexiWork - Plumber</div>
		<ul>
	...
	<form action="SearchByLocation" method="post">
		<div class="search-bar-container"
			...
			<input type="hidden" name="domain" value="Plumber" />
	...
	<div class="card-container">
		<div class="worker-card">
			...
			<p class="title">Expert Plumber</p>
			<p> Residential & Commercial</p>
			<div class="skills">
				<span>Tap Expert</span> <span>Leakage Repair</span> <span>Fiting</span>
			</div>
			...
			<form action="workerProfile.jsp" method="post"
					...
					<input type="hidden" name="field" value="Plumber">
