...
<body>
	<nav class="navbar">
		<div class="logo">FlexiWork - Carpenter</div>
		<ul>
	...
	<form action="SearchByLocation" method="post">
		<div class="search-bar-container"
			...
			<input type="hidden" name="domain" value="Carpenter" />
	...
	<div class="card-container">
		<div class="worker-card">
			...
			<p class="title">Certified Carpenter</p>
			<p> Residential & Commercial</p>
			<div class="skills">
				<span>Cutting</span> <span>Modern Desgining</span> <span>High Quality</span>
			</div>
			...
			<form action="workerProfile.jsp" method="post"
					...
					<input type="hidden" name="field" value="Carpenter">
