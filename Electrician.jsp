...
<body>
	...
	<form action="SearchByLocation" method="post">
		<div class="search-bar-container"
			...
			<input type="hidden" name="domain" value="Electrician" />
	...
	<div class="card-container">
		<div class="workers-content">
			<div class="worker-card">
				<img src="data:image/jpeg;base64,<%=worker.get("photo")%>%>"
					alt="Electrician Photo" class="profile-img" />
				...
				<!-- loop to use values while clicking on the button -->
