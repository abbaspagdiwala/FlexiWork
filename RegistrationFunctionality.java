...
public class RegistrationFunctionality extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (role.equals("user")) {
                    registerUser(conn, name, email, pass, ph , city, state, resp, role);
                } else {
                    registerWorker(conn, uname, name, email, pass, ph, imageStream, domain, city, state, exp, resp, role);
                }
            }
    ...
    private void registerUser(Connection conn, String name, String email, String pass, String ph, String city, String state, HttpServletResponse resp, String role) {
        try {
    ...
    //register for worker
    private void registerWorker(Connection conn, String uname, String name, String email, String pass, String ph, InputStream imageStream, String domain, String city, String state, String exp, HttpServletResponse resp, String role) {
        try {
