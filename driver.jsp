...
<body>
	<nav class="navbar">
		<div class="logo">FlexiWork - Driver</div>
		<ul>
	...
	<form action="SearchByLocation" method="post">
		<div class="search-bar-container"
			...
			<input type="hidden" name="domain" value="driver" />
	...
	<div class="card-container">
		<div class="worker-card">
			<img src="/" alt="Electrician Photo" class="profile-img" />
			<h2><%=worker.get("name")%></h2>
			<p class="title">Certified Driver</p>
			<p> Residential & Commercial</p>
			<div class="skills">
				<span>Defensive Driving</span> <span>Vehicle Maintenance</span> <span>GPS & Navigation</span>
			</div>
			...
			<form action="workerProfile.jsp" method="post"
					...
					<input type="hidden" name="field" value="Driver">
